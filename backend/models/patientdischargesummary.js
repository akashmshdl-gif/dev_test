...
module.exports = (sequelize, DataTypes) => {
  class PatientDischargeSummary extends Model {
    static associate(models) {
      PatientDischargeSummary.belongsTo(models.Patient, {
        foreignKey: 'patient_id',
        targetKey: 'fhir_id'
      });
    }
  }
  PatientDischargeSummary.init({
    ...
    sequelize,
    modelName: 'PatientDischargeSummary',
    tableName: 'patient_discharge_summary'
  });
  return PatientDischargeSummary;
};
